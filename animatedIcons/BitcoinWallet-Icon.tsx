...
export function BitcoinWalletIcon() {
  return (
    ...
    >
      ...
      {/* Bitcoin symbol */}
      <motion.path variants={{hover:{stroke:"#F5C542"} }} d="M3.125 19.5L3.125 13.5M5 13.5V12M5 21V19.5M3.125 16.5H6.875M6.875 16.5C7.49632 16.5 8 17.0037 8 17.625V18.375C8 18.9963 7.49632 19.5 6.875 19.5H2M6.875 16.5C7.49632 16.5 8 15.9963 8 15.375V14.625C8 14.0037 7.49632 13.5 6.875 13.5H2" />
    </motion.svg>
  );
}
