...
export function ChartCandleIcon({ size = 32 }: { size?: number }) {
  return (
    <motion.svg
      width={size}
      height={size}
    ...
    >
      <motion.g
        ...
        transition={{ ...candleTransition, delay: 0 }}
      >
        ...
        <path d="M9 9V5M9 15V17" />
      </motion.g>
      <motion.g
        variants={{
          hover: { y: [0, -2.25, 0] },
        }}
        transition={{ ...candleTransition, delay: 0.08 }}
      >
