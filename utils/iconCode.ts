...
export function CameraIcon() {
  return (
    ...
    >
        ...
        <motion.circle variants={{hover:{opacity:[1,0,1]}}} transition={{duration:0.4}} cx={18} cy={9} r={0.5} fill="white"/>
    </motion.svg>
  )
}`.trim(),
battery:`
...
clock:`import { motion } from "framer-motion";
...
mail:`import { motion } from "framer-motion";
...
export function AirplaneOffIcon() {
  return (
    <div>
        <motion.svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="40" height="40" color="white" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"
        whileHover='hover'
        >
    <motion.path variants={{hover:{opacity:[0.5,0.5,1]}}} d="M13.1795 13.8261L12.9201 16.1149C12.8261 16.9448 12.779 17.3598 12.915 17.7398C13.2335 18.63 14.3149 19.3591 14.9753 20.0066C15.3403 20.3644 15.7386 21.3934 15.3224 21.8613C15.0655 22.1503 14.6481 21.9157 14.3609 21.803L11.5952 20.7184C11.2645 20.5887 11.0991 20.5239 10.9255 20.5239C10.7519 20.5239 10.5865 20.5887 10.2558 20.7184L7.49016 21.803C7.20291 21.9157 6.78553 22.1503 6.52858 21.8613C6.11239 21.3934 6.51073 20.3644 6.87572 20.0066C7.53614 19.3591 8.61751 18.63 8.936 17.7398C9.07199 17.3598 9.02496 16.9448 8.93091 16.1149L8.67153 13.8261L2.89514 15.1587C2.29655 15.2968 1.99982 15.1155 2 14.4391C2.00033 13.1971 2.39739 12.537 3.40543 11.9183L6.6995 9.89656C7.25228 9.55783 7.52868 9.38846 7.71947 9.15616C7.99925 8.81552 8 8 8 8" />
    <motion.path variants={{hover:{opacity:[0.5,0.5,1]}}} d="M8.50006 4C8.97205 3.18656 9.71858 2.43508 10.4364 2.11845C10.7944 1.96052 11.2051 1.96052 11.5631 2.11845C12.7264 2.63158 13.8804 4.28671 14.0089 5.49686C14.1331 6.66595 13.3999 8.15082 14.2325 9.15616C14.4248 9.38846 14.7035 9.55783 15.2609 9.89656L18.5827 11.9182C19.5993 12.5369 19.9998 13.1973 19.9998 14.4395C19.9998 14.9429 19.5001 15.5 19.5001 15.5" />
    <motion.path variants={{hover:{scale:[1,1.5,1]}}} d="M2 2L22 22" />
</motion.svg>
    </div>
  )
}`.trim(),
...
export function AirdropIcon() {
  return (
    ...
    <motion.path variants={{hover:{opacity:[0,1]}}} d="M7.52779 15C6.57771 13.9385 6 12.5367 6 11C6 7.68629 8.68629 5 12 5C15.3137 5 18 7.68629 18 11C18 12.5367 17.4223 13.9385 16.4722 15" />
  ...
  return (
    <div>
        ...
        >
            ...
            <motion.path variants={{hover:{pathLength:[0,1]}}} d="M2 17.5C2 17.5 10.5 23.5844 19 19.5281C19 19.5281 10.5 25.1056 2 17.5Z" />
            <motion.path variants={{hover:{pathLength:[0,1]}}} transition={{delay:0.2}} d="M21.99 17.7025C22.136 19.0999 20.6414 21 20.6414 21C20.6414 21 21.6208 19.4076 21.4245 17.7025C19.8212 17.0648 18 17.7895 18 17.7895C18 17.7895 19.5024 16.685 21.4245 17.0888C21.7265 17.1522 21.9579 17.3956 21.99 17.7025Z" />
        </motion.svg>
    </div>
  )
}`.trim(),
